...
class Move_robot_handler:
    ...
    def move_robot(self):
        ...
        if shortest_distance < robot_radius_px:
            ...
            d_angle_degrees = 5
            d_angle_rad = d_angle_degrees * math.pi/180.0
            random_number = random.randint(0,3)
            if random_number == 1:
                velocity = velocity.rotate_by(d_angle_rad)
...
robot_position = Vector(315, 495)
robot_velocity = Vector(28.571428571428537, -49.487165930539376)
